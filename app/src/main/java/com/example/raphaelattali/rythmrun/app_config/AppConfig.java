...
/**
 * Classe regroupant toutes les constantes nécessaires au paramétrage de l'application
 */
public final class AppConfig {
    ...
    /**
     * SERVEUR LOCAL WAMP
     * public static String URL_LOGIN = "http://192.168.0.45/android_login_api/rhythmrun_login.php";
     */
